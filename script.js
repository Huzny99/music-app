    ...
    musicLibrary = [
      {
        ...
        title: "Good Days",
        artist: "Aylex",
        path: "Aylex - Good Days (freetouse.com).mp3",
        duration: "1:58",
      },
      {
        id: 2,
        ...
        path: "Ethan Sturock - A New Day (freetouse.com).mp3",
        duration: "3:22",
      },
      {
        id: 3,
        title: "November",
        artist: "Limujii",
        path: "Limujii - November (freetouse.com).mp3",
        duration: "2:47",
      },
      {
        id: 4,
        ...
        path: "Luke Bergs & Lichu - Exotic (freetouse.com).mp3",
        duration: "2:44",
      },
      {
        id: 5,
        ...
        path: "Moavii - Dagored - Metropolitan (freetouse.com).mp3",
        duration: "1:41",
      },
      {
        id: 6,
        title: "Endless",
        artist: "Moavii",
        path: "Moavii - Endless (freetouse.com).mp3",
        duration: "2:39",
      },
      {
        id: 7,
        title: "Sonnea",
        artist: "Moavii",
        path: "Moavii - Sonnea (freetouse.com).mp3",
        duration: "1:52",
      },
      {
        id: 8,
        title: "Stadium Rock",
        artist: "Pufino",
        path: "Pufino - Stadium Rock (freetouse.com).mp3",
        duration: "1:53",
      },
      {
        id: 9,
        title: "Hawaii",
        artist: "Waesto",
        path: "Waesto - Hawaii (freetouse.com).mp3",
        duration: "3:05",
      },
      {
        id: 10,
        title: "Sunset",
        artist: "Waesto",
        path: "Waesto - Sunset (freetouse.com).mp3",
        duration: "2:14",
      },
      {
        id: 11,
        title: "Leader",
        artist: "Zambolino",
        path: "Zambolino - Leader (freetouse.com).mp3",
        duration: "1:35",
      },
      {
        id: 12,
        title: "Smooth Place",
        artist: "Zambolino",
        path: "Zambolino - Smooth Place (freetouse.com).mp3",
        duration: "1:57",
      },
    ];
